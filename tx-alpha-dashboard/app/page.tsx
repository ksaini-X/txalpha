...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-cyan-900/10 via-transparent to-blue-900/10" />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <p className="text-slate-400 text-base md:text-lg max-w-3xl mb-12 leading-relaxed">
          Transform raw World Cup odds and event data into live
          implied-probability charts, event commentary, and verified match
          settlement. Trade with precision using institutional-grade market
          intelligence.
        </p>
